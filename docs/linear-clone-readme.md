...
└── features/
    └── linear-clone/
        ...
        ├── feature-section.tsx       # Reusable feature component
        ...
        └── animations/
            ...
            └── use-scroll-reveal.tsx # Scroll hook
```
...
- 3D product mockup with Three.js
...
# Visit linear clone
open http://localhost:3000/linear-clone
```
...
1. **Animations not triggering**
   - Check if `useScrollReveal` ref is attached
   - Verify threshold value (try 0.1 or 0.2)
...
3. **Performance issues**
   ...
   - Increase scroll reveal threshold
...
- [Linear.app](https://linear.app) - Original site
...
This is a clone for educational purposes. All rights belong to Linear.
